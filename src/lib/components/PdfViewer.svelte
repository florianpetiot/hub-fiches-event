...
<button type="button" onclick={openPdf} disabled={loading}
  class="inline-flex items-center gap-2 text-sm text-blue-400 hover:text-blue-300 active:text-blue-300 disabled:opacity-50 transition-colors print:hidden hover:cursor-pointer">
