<script lang="ts">
  ...
  const colors = {
    red:    { border: 'border-red-600',    text: 'text-red-500',    bg: 'bg-dark-red-accent hover:bg-red-500',      focus: 'focus:border-red-500' },
    blue:   { border: 'border-blue-600',   text: 'text-blue-500',   bg: 'bg-blue-600 hover:bg-blue-700',            focus: 'focus:border-blue-500' },
    green:  { border: 'border-green-600',  text: 'text-green-500',  bg: 'bg-green-600 hover:bg-green-700',          focus: 'focus:border-green-500' },
    yellow: { border: 'border-yellow-600', text: 'text-yellow-500', bg: 'bg-yellow-600 hover:bg-yellow-700',        focus: 'focus:border-yellow-500' },
    orange: { border: 'border-dark-orange-accent', text: 'text-dark-orange-accent', bg: 'bg-dark-orange-accent hover:bg-dark-orange-500', focus: 'focus:border-dark-orange-500' },
  }
  ...
  <div class="bg-dark-terciary border-t-3 border-b {c.border} rounded-lg p-6 w-full max-w-md space-y-4">
    ...
    <div class="flex gap-3">
      <button type="button"
        ...
        class="flex-1 border border-gray-600 text-gray-400 hover:text-white py-2 rounded-lg transition-colors">
        Annuler
      </button>
      <button type="button"
