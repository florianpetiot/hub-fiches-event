<div class="min-h-screen bg-dark-terciary flex items-center justify-center p-4">
  <div class="bg-dark-secondary rounded-lg p-8 w-full max-w-sm space-y-6 text-center">
    ...
    <button
      ...
      class="w-full border border-blue-500 text-blue-400 hover:bg-blue-600 hover:text-white py-2 rounded-lg text-sm font-medium transition-colors">
      Réessayer
    </button>
